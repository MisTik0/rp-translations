local my_language = {
	...
	my_player = "My player",
	reports_list = "Reports management",
	report_management = "Report management",
	report_take = "Take report",
	report_close = "Close report",
	report_took = "You took the report #%d",
	report_closed = "You closed the report #%d",
	report_sent = "Your report has been sent.",
	report_not_found = "Report not found.",
	report_already_taken = "This report is already taken.",
	report_need_to_be_taken = "You need to take the report to close it.",
	player = "Player",
	world = "World",
	main_menu = "Main menu",
	...
	car_dealerls = "South vehicle dealer",
	car_dealerbc = "North vehicle dealer",
	...
	success_x_chips = "~g~Bet OK!~w~ You won ~b~$%s~w~",
	...
	left_table_refund = "You left the table and got your bets back +$~b~%s~w~.",
	...
	x_bet_x_game = "~g~%s~w~ bets ~g~$%s~w~. (%s)",
	...
	you_already_reported = "~r~You already reported recently.",
	server_id = "Server ID",
	...
	tax_veh_bike_title = "Tax on bikes",
	tax_veh_volume_title = "Tax on vehicle volume",
	tax_veh_plane_title = "Tax on planes & helicopters",
	tax_veh_boat_title = "Tax on boats",
	tax_veh_super_title = "Tax on supercars",
	tax_pro_garage_title = "Tax on rented garages",
	tax_pro_house_title = "Tax on rented houses",
	tax_pro_garage_ownership_title = "Tax on owned garages",
	tax_pro_house_ownership_title = "Tax on owned houses",
	tax_pro_neighborhood_title = "Tax on neighborhoods",
	tax_gl_fuel_title = "Fuel tax",
	tax_gl_vat_title = "Sales tax",
	tax_gl_licenses_title = "Tax on licences",
	tax_gl_salary_title = "Tax on salary",
	tax_gl_prod_title = "Tax on production",
	cred_veh_green_title = "Environment friendly vehicles welfare",
	cred_housing_title = "Housing welfare",
	cred_healthcare_title = "Healthcare welfare",
	tax_modifications_saved = "~g~The state taxes have been updated.",
	credit_modifications_saved = "~g~The state credits and perks have been updated.",
	...
	delamain_place_destination_marker = "~b~Please place a marker on the map.\n~w~Press %s to confirm the destination.",
	delamain_place_destination_marker_price_x = "~b~Please place a marker on the map.\n~w~Press %s to confirm.\nPrice of the travel: ~g~$%s",
	delamain_arrived_enter_inside = "Delamain has arrived.\n~b~Enter the vehicle to go to your destination.",
	delamain_must_be_near_road = "~r~You must be near a accessible road to call Delamain.",
	delamain_cannot_drive_outside_county = "~r~Delamain cannot travel accross county borders.",
	-- Subtitles
	delamain_intro_01 = "Welcome on board, this is Delamain service. With Delamain you leave your problems at the door.",
	delamain_intro_02 = "Welcome to the Delamain network, how are you today?",
	delamain_intro_03 = "Welcome on board, this is Delamain service. Travelling at the speed of luxury.",
	delamain_intro_04 = "Hello, thank you for choosing the Delamain service.",
	delamain_hurry_answer = "I am doing what I can.",
	delamain_outro_01 = "Thank you for choosing the Delamain service and best of luck!",
	delamain_outro_02 = "Thank you for choosing the Delamain service and best of luck.",
	delamain_outro_03 = "Thank you for choosing the Delamain service, have a nice day.",
	delamain_sarcasm = "Sarcasm, funny.",
	delamain_confirm_01 = "Understood.",
	delamain_confirm_02 = "If that's what is required, yes.",
	delamain_confirm_03 = "Of course, understood.",
	delamain_confirm_04 = "Understood, recalculating route.",
	delamain_confirm_05 = "As you wish.",
	delamain_confirm_06 = "I have chosen the optimum route. We will be arriving shortly.",
	delamain_confirm_07 = "Your wish is my command.",
	delamain_random_dialogue_01 = "While on board you are entirely within your rights to bear and use me.",
	delamain_random_dialogue_02 = "I can ensure you that whatever happen aboard a vehicle in the Delamain fleet is kept under the tightest wraps.",
	delamain_random_dialogue_03 = "No delay anticipated.",
	delamain_random_dialogue_04 = "Please sit back, relax and enjoy the stunning view of our fine city.",
	delamain_random_dialogue_05 = "Judging by my client reviews, the city is truly breathtaking.",
	delamain_random_dialogue_06 = "This city as certain of my clients note is a true west coast jet.",
	delamain_arrive_soon_01 = "We are nearing our destination.",
	delamain_arrive_soon_02 = "We should be arriving shortly.",
